...
const en = {
  ...
  navStorage: "Storage",
  colFiles: "Files",
  storageSubSource: "Source video",
  storageSubPoster: "Poster & sprite",
  storageSubFlavors: "Flavors",
  storageSubSubtitles: "Subtitles",
  storageSubOther: "Other",
  storageSystem: "System",
  storageSystemUploads: "Uploads (spools)",
  storageSystemLogs: "Logs",
  storageSystemCache: "Cache",
  storageEmpty: "No media files yet — uploads will appear here.",
  storageUsageLine: "{pct}% of {total} · {free} free",
  storageObjects: "{n} objects",
  navSignIn: "Sign in",
  langLabel: "Language",
  langEnglish: "English",
  signOut: "Sign out",
  ...
  jobAbortTitle: "Abort this job?",
  jobAbortDesc:
    "Running work is stopped immediately. Cancelled jobs can be retried later.",
  jobDone: "Done",
  jobProbe: "Probe",
  ...
  jobsActiveEncoding: "Active background encoding",
  jobsWaitingPool: "Waiting for worker pool",
  jobsRequiresAttention: "Requires attention or retry",
  jobsDoneCount: "{n} completed",
  subtitleUploadTitle: "Upload Subtitle Track",
  subtitleFileLabel: "Subtitle File (.vtt)",
  subtitleClickToSelect: "Click to select .vtt file",
  subtitleVttRequired: "WebVTT caption format required",
  languageCode: "Language Code",
  displayLabel: "Display Label",
  subtitlesSectionTitle: "Subtitles & Captions",
  subtitlesSectionDesc: "Manage WebVTT caption tracks for multi-language playback.",
  ...
  srToggleSidebar: "Toggle Sidebar",
  ...
  // players
  playersNew: "New player",
  playersName: "Name",
  playersNamePlaceholder: "e.g. Branded",
  playersDesign: "Design",
  playersActions: "Actions",
  playersDefault: "Default",
  playersEmpty: "No players yet — create one to customize the player look.",
  playersDeleteTitle: "Delete {name}?",
  playersDeleteDesc: "Entries using this design fall back to the Default player.",
  playersEditTitle: "Edit {name}",
  playersAccent: "Accent color",
  playersLogo: "Logo",
  playersLogoUrl: "Logo URL",
  playersLogoHref: "Logo link",
  playersLogoPosition: "Position",
  playersLogoSize: "Size (px)",
  playersLogoOpacity: "Opacity",
  playersLoader: "Loading spinner",
  playersLoaderHint: "Show a spinner while the video is buffering.",
  playersAutoHide: "Auto-hide controls",
  playersAutoHideHint: "Hide the control bar until hover.",
  playersLogoShort: "logo",
  playersNoLoaderShort: "no loader",
  playersSelectLabel: "Player design",
  playersSelectHint: "Which player design this entry uses.",
  chgPlayer: "Player",
  ...
  libraryLoginTitle: "Viewer sign in",
  libraryLoginDesc: "Sign in to browse the library.",
  librarySignOut: "Sign out",
  libraryBackToLibrary: "Back to library",
  navViewers: "Viewers",
  viewerNew: "New viewer",
  viewerEditTitle: "Edit viewer",
  viewerDeleteTitle: "Delete viewer?",
  viewerDeleteDesc: "The viewer can no longer sign in. Their sessions are revoked.",
  viewerCreated: "Viewer created",
  viewerUpdated: "Viewer updated",
  viewerNameSurname: "Name & surname",
  viewerPassword: "Password",
  viewerPasswordHint: "leave blank to keep the current password",
  viewerActive: "Active",
  viewerDisabled: "Disabled",
  viewerColEmail: "Email",
  viewerColName: "Name",
  viewerColStatus: "Status",
  viewerColCreated: "Created",
  viewerEmpty: "No viewers yet — create one to let people sign in to the library.",
