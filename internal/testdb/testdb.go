...
func Pool(t *testing.T) *pgxpool.Pool {
	...
	// Migration 0005 pins pg_trgm to the public schema (WITH SCHEMA public),
	// so no pre-creation is needed here; bootstraps are serialized by the
	// bootstrap advisory lock, and every isolated schema resolves the
	// extension objects via the ", public" search_path fallback below.
